        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <!-- <li class="overview dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="<?php print $base_path; ?>projects-overview">Dashboard</a> -->
	  ...
	  <div class="social">
		 ...
		 <div class="row-fluid content">
		   ...
		   <div class="span7">
		    ...
		    //    	if($node->nid == "10") { print views_embed_view('about_page_slideshow','block'); } 
		        ?>
